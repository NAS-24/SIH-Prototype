...
const ContributorRolePage = () => {
    ...
    const handleRoleSelection = (roleName) => {
        ...
        // 1. Store the SPECIFIC sub-role name (e.g., Coastal Guard)
        localStorage.setItem('selectedRole', roleName);
        
        // 2. We don't need to re-create the mockId here, as it was already created 
        //    in LoginPage.jsx, ensuring it remains the same persistent ID.

        // 3. Navigate to the main status tracker/reports page
        navigate('/reports')
    }
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                        {roles.map((role, index) => (
                            <Card 
                                ...
                                className="relative cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                            >
